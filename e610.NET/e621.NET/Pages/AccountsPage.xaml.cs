...
namespace e610.NET
{
    ...
    public sealed partial class AccountsPage : Page
    {
        ...
        private void GetSettings()
        {
            ...
            { 
                ...
                if (GlobalVars.LoggedInInfo != null)
                {
                    ...
                    BlacklistBox.Text = CurrentUser.blacklisted_tags;
        ...
        private void ImageGrid_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            Bindings.Update();
            this.Frame.Navigate(typeof(PostsViewPage), pick, new DrillInNavigationTransitionInfo());
        }
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            GlobalVars.searchText = "fav:"+ GlobalVars.Username;
            int tabIndex = MainPage.MainTabViewAccess.SelectedIndex;
            (MainPage.MainTabViewAccess.TabItems[tabIndex] as TabViewItem).Header = GlobalVars.searchText;
            Bindings.Update();
        ...
        private void SaveBlacklistButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            client.BaseUrl = new Uri("https://e621.net/users.json?");
            client.UserAgent = "e610.NET/1.6(by EpsilonRho)";
            request.AddQueryParameter("blacklisted_tags", BlacklistBox.Text);
            request.AddQueryParameter("search[name_matches]", GlobalVars.Username);
            if (GlobalVars.Username != "" && GlobalVars.APIKey != "")
            {
                request.AddQueryParameter("login", GlobalVars.Username);
